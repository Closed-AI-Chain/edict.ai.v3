...
def yt_upload_video(filename, title, description):
    ...
    os.system(f''' python3 upload_video.py --file="{working_directory}/videos/{filename}" --title="{title}" --description="{new_description}" --keywords="Edict.AI" --category="22" --privacyStatus="unlisted" ''')
