...
def edict_video(url):
    ...
    for i, chunk in enumerate(chunks):
        ...
        textembed=TextClip(new_chunk,fontsize=40,color="white",font="fonts/RobotoSlab-Regular.ttf",stroke_color="black",stroke_width=1).set_position(("center",973)).set_duration(did_duration)
    ...
    final_clip.write_videofile("videos/news_edicted_12.mp4")
    
    youtubeLink = yt_upload_video("news_edicted_12.mp4", data["headline"], data["content"])
    print(youtubeLink)

    return("videos/news_edicted_12.mp4")
