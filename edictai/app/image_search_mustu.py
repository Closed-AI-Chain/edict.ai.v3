...
def google_image_search_api(query,chunk_number):
    ...
    gis = GoogleImagesSearch('AIzaSyARlIMRzaXGWQX1rcrbGyHlSniAX1PfNYg', '1767a2d38eff54836')
    ...
    try: 
        ...
        gis.search(search_params=_search_params, path_to_dir='images/', width=1140, height=670)
